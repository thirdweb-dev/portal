...
function useModuleCodeSnippetQuery() {
  return useQuery(["code-snippet"], async () => {
    const tsRes = await fetch(
      `https://raw.githubusercontent.com/nftlabs/nftlabs-sdk-ts/main/docs/snippets.json`,
    );
    const pyRes = await fetch(
      "https://raw.githubusercontent.com/nftlabs/nftlabs-sdk-python/master/snippets/snippets.json",
    );
