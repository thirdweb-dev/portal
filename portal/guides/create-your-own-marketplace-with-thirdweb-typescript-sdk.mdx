...
The first thing we need to do is head over to the [dashboard](https://thirdweb.com/dashboard) and create a project and a **Marketplace** contract. if you don't know how to do this, check out [this guide](/learn/introduction).
...
![](/assets/portal/guides/create-your-own-marketplace-with-thirdweb-typescript-sdk/1.png)
...
- **@thirdeb-dev/sdk** - thirdweb TypeScript SDK.
...
Now we need to define which contract we want to use. We created the contract ajd called it '**Cool NFT Marketplace**'. This contract has an address. We need to pass the address here. You can find the address here, under '**Cool NFT Marketplace**':
...
// Declaring the token contract adress if you want to use your own tokens
...
marketplace.direct.createListing({
