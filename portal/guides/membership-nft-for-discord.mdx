...
draft: false
tags: [edition, mint, discord, access]
...
3. Add a name and description for your collection. (This will be displayed when users view the collection page on Opensea).
4. Click Deploy → confirm transactions in your wallet.
