...
4. Create the homepage. Once the wallet of the user is connectect, they can go ahead and get a 'signature' or go and use their 'signature' to mint an NFT.
