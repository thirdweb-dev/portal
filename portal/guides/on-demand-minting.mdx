...
We need to use the thirdweb and chakra providers. You can use the [thirdweb nextjs starter](https://github.com/thirdweb-example/next-typescript-starter) to kickstart this. Here we are using the Mumbai chain.
...
The `Flex` library is used to style our component and we're using the `useMetammask` hook here to get our **connect wallet** button. If you want to know more about the connect wallet button component, click [here](https://thirdweb.com/portal/guides/add-connectwallet-to-your-website).
