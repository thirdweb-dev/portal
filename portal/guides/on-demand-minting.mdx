...
Next up we create a component folder. Create a `Layout.ts` file for our layout and connect wallet button.
...
Anyone passing the **payload** can mint an unique NFT!
