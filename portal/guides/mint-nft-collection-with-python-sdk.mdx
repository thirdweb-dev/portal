...
The first thing we need to do is head over to the [dashboard](/dashboard) and create a project and an **NFT Collection** module. if you don't know how to do this, check out [this guide](/learn/introduction).
