...
## Adding user's to allowlist

I am going to add a simple button for adding user's to allowlist. You can even create an early access form or something similar. So, create a button in `index.tsx`:
