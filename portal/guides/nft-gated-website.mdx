...
3. Add a module: _Bundle Collection (ERC 1155)_.
...
const useWalletMembershipAccess = () => {
  // react states for checking if user can access or not
...
You can check the code on GitHub here: https://github.com/thirdweb-dev/nextjs-membership-lounge.
