...
You can grab a copy of the final project from our examples repository: [https://github.com/thirdweb-example/NFT-Gated-Website](https://github.com/thirdweb-example/NFT-Gated-Website).
...
Link to NFT Drop dashboard for Cookie Club: [https://thirdweb.com/dashboard/rinkeby/nft-drop/0x66463b3C1EBf08b9dE889BCc0A5cbf29dc0e2B7a?tabIndex=0](https://thirdweb.com/dashboard/rinkeby/nft-drop/0x66463b3C1EBf08b9dE889BCc0A5cbf29dc0e2B7a?tabIndex=0)
...
First, navigate to [https://github.com/thirdweb-example/cra-javascript-starter](https://github.com/thirdweb-example/cra-javascript-starter) and click on "Use this template" to create a copy.
...
You can grab a copy of this project from the our examples repository: [https://github.com/thirdweb-example/NFT-Gated-Website](https://github.com/thirdweb-example/NFT-Gated-Website)
