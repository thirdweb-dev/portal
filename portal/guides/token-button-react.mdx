...
In your `tokencomponent.js` file we will write the code for the button and get balance. If you want to know more about the token module you can find a guide [here](https://thirdweb.com/portal/guides/create-your-currency-with-typescript-sdk).
