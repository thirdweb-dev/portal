...
🛑 In order to use this feature you need to make sure your `NFT Drop` contract is deployed after 02-02-2022. Older versions of this contract do not support the delayed-reveal feature.

This guide assumes you already know how to make a contract though the thirdweb dashboard. If you need a refresher, please check out our [Create Contracts on thirdweb](https://portal.thirdweb.com/contracts) guide. 
