...
The first thing we need to do is head over to the [dashboard](/dashboard) and create a project and a **NFT Collection**, **Bundle**, **Drop** or **Bundle Drop** module, you can make your NFT non-transferable in any of these. If you don't know how to create a project, check out [this guide](/learn/introduction).
