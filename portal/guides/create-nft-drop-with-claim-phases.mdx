...
This guide assumes you have created an NFT Drop or Edition Drop on thirdweb and now need to set up claim settings. If you need a refresher on how to do so, check out our [NFT Drop with Delayed Reveal Guide](https://portal.thirdweb.com/guides/nft-drop-with-delayed-reveal).
...
!["When will this phase start?" field](public/assets/portal/guides/create-nft-drop-with-claim-phases/1.png)
...
!["How many NFTs will you drop in this phase?" field](public/assets/portal/guides/create-nft-drop-with-claim-phases/2.png)
...
![Setting up the prices field](public/assets/portal/guides/create-nft-drop-with-claim-phases/3.png)
...
![Upload Snapshot Drag & Drop screen](public/assets/portal/guides/create-nft-drop-with-claim-phases/4.png)
...
![Snapshot edited on Google Sheets](public/assets/portal/guides/create-nft-drop-with-claim-phases/5.png)
...
![Save Snapshot screen](public/assets/portal/guides/create-nft-drop-with-claim-phases/6.png)
...
![Setting limits on "How many NFTs can be claimed per transaction?"](public/assets/portal/guides/create-nft-drop-with-claim-phases/7.png)
...
![Second claim phase with fields populated](public/assets/portal/guides/create-nft-drop-with-claim-phases/8.png)
...
![Gold Sticker Drop embed](public/assets/portal/guides/create-nft-drop-with-claim-phases/9.png)

Notice how the embed states, "**This drop is not yet ready to be claimed."**
