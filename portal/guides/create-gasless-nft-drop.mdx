---
title: How to create a gasless NFT drop with Next.js and thirdweb
...
summary: "Create a gasless NFT drop with Next.js and thirdweb"
image: "/assets/portal/guides/create-nft-drop-with-claim-phases/thumbnail.png"
date: "2022-04-03"
updated: ""
---

In some cases, you might wanna pay the gas for NFT drops like early access drops or when you are accepting payments in some other forms. So in this guide, we are going to see how to create a gasless NFT drop that everyone can claim. I am going to use an ERC-1155 so multiple people can hold the same NFT but you can do it any way you like!
...
![New Editon drop](/assets/portal/guides/create-gasless-nft-drop/new-edition-drop.png)
...
Wrap the whole app in the thirdweb Provider like the following-
...
![Editon drop address](/assets/portal/guides/create-gasless-nft-drop/edition-drop-address.png)
...
We are going to use [Openzeppelin](https://defender.openzeppelin.com/) to relay the gas, so head over to Openzeppelin and sign up for an account if you haven’t already.

Create a new relayer in openzepplin-
...
Want to have a look at the code? [We got you!](https://github.com/avneesh0612/gasless-drop)
