...
The first thing we need to do is head over to the [dashboard](https://thirdweb.com/dashboard) and create a project and a **Drop** contract. if you don't know how to do this, check out [this guide](/learn/introduction).
...
Now we need to define which contract we want to use. This is the contract we just created inside our project. We called the contract **My Drop**. This contract has an address. We need to pass the address here. You can find the address here, under **My Drop**:

![](/assets/portal/guides/create-a-drop-with-typescript-sdk/1.png)
...
Once your **Drop** contract has been created and has some NFTs. set the **Claim Phases**. These phases are some of the rules we'll apply when someone wants to claim an NFT, such as price, max amount of tokens claimed, wallets allowed to claim, etc. 
...
const claimConditions = [
  {
    ...
    snapshot: ['0x...', '0x...'], // limit minting to only certain wallet addresses
  },
  {
