...
![New NFT Drop contract viewed in the thirdweb dashboard](/assets/portal/guides/create-a-drop-with-typescript-sdk/NFT_Drop_Contract_Dashboard_View.png)
...
![See NFT Drop contract address under contract name](/assets/portal/guides/create-a-drop-with-typescript-sdk/NFT_Drop_Contract_Dashboard_View.png)
