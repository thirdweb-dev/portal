...
## Dashboard setup
The first thing we need to do is head over to the [dashboard](https://v1.thirdweb.com/dashboard) and create a **NFT Collection** contract. if you don't know how to do this, check out [this guide](/learn-thirdweb).
