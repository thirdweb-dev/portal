...
![](/assets/portal/guides/switch-between-networks/select-network-on-create-new-contract.png)

Another way to switch between networks is to click on your wallet inside your browser.

![](/assets/portal/guides/switch-between-networks/change-network-in-wallet.png)

Finally you can also switch between networks inside the thirdweb dashboard.

![](/assets/portal/guides/switch-between-networks/switch-network-in-dashboard.png)
...
![](/assets/portal/guides/switch-between-networks/rinkeby-final-mobile.png)