...
![](/assets/portal/guides/switch-between-networks/connect-wallet.png)

Another way to switch between networks is to click on your wallet inside your browser.

![](/assets/portal/guides/switch-between-networks/rinkeby.png)

Finally you can also switch between networks inside the thirdweb dashboard.

![](/assets/portal/guides/switch-between-networks/ethereum-selected.png)
...
![](/assets/portal/guides/switch-between-networks/get-started.png)

![](/assets/portal/guides/switch-between-networks/connect-wallet-dashboard.png)

![](/assets/portal/guides/switch-between-networks/thirdweb-walletconnect.png)
