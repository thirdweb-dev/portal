...
This guide gives you a simple React **component** to create an `auction` and a **component** for a `connect wallet` button. Check out our repo with examples at Github [here](https://github.com/thirdweb-dev/examples/tree/main/typescript/claim-button-react).
