...
author: "Samina"
authorAvatar: "/assets/portal/authors/samina.png"
authorTwitter: "https://twitter.com/saminacodes"
draft: false
tags: [NFT, Edition, NFT-Drop]
summary: "In this guide, we will go over how to set up a CSV or a JSON file to upload your NFTs in the batch upload feature."
image: "/assets/portal/guides/how-to-batch-upload/thumbnail.png"
date: "2022-05-03"
updated: ""
---
...
With an [NFT Drop](https://portal.thirdweb.com/contracts/nft-drop) or [Edition Drop](https://portal.thirdweb.com/contracts/edition-drop), you can batch upload NFTs through a CSV or JSON file. 
...
![Batch Upload button on thirdweb's dashboard](/assets/portal/guides/how-to-batch-upload/batch-upload-button.png)

Download the sample CSV file (recommended) or JSON on the next screen, which holds an example of the expected structure.

![Download example CSV on upload screen](/assets/portal/guides/how-to-batch-upload/download-csv.png)
...
![Sample CSV file from download opened in Google Sheets](/assets/portal/guides/how-to-batch-upload/sample-csv.png)
...
![Populated CSV file with shapes collection](/assets/portal/guides/how-to-batch-upload/shapes-properties.png)
...
![Properties file opened in VS Code](/assets/portal/guides/how-to-batch-upload/shapes-vscode.png)
...
![Directory filled with images of shapes](/assets/portal/guides/how-to-batch-upload/shapes-directory.png)
