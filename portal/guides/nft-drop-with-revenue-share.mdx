...
For the purposes of this guide, we’ll assume you know how to set up the rest of your NFT Drop. For more information on how to complete your NFT drop, check out [this](https://portal.thirdweb.com/guides/release-an-nft-drop-with-no-code) guide. 
