---
title: Create An NFT Drop With Automatic Revenue Share
...
summary: "Learn how to deploy a no-code NFT drop using the thirdweb Split smart contract and automatically share revenue with designated recipients."
...
Welcome to this **Split** contract guide! The Split contract is a powerful feature that enables you to automatically share revenue with a designated group of people via their digital wallet, entirely on the blockchain. By building in this programmatic functionality to distribute funds to multiple parties with contract logic, we’re enabling powerful uses cases for creators across music, art, and even social good initiatives.

Whether you are part of a DAO (decentralized autonomous organization), working with a large team, or just a handful of partners - all you need are the crypto wallet addresses of the recipients and desired allocation for your split contract. Keep in mind, you are literally coding these revenue share parameters into your smart contract — they are immutable after deploying to the blockchain. Make sure to consider your choices wisely. With that, you’re ready to launch your first smart contract revenue split. 
