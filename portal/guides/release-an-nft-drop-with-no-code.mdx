...
First, we need to create a project on thirdweb, which can be done on [thirdweb dashboard](https://thirdweb.com/dashboard).
...
![Drop module creation](/assets/portal/guides/release-an-nft-drop-with-no-code/drop-module-creation.png)
...
![Drop settings](/assets/portal/guides/release-an-nft-drop-with-no-code/drop-module-settings.png)
...
![All the permisions you can set](/assets/portal/guides/release-an-nft-drop-with-no-code/permissions.png)
...
![Bulk Create button](/assets/portal/guides/release-an-nft-drop-with-no-code/bulk-create-button.png)
...
![Preview before uploading](/assets/portal/guides/release-an-nft-drop-with-no-code/preview.png)
...
![Our dashboard with all the Pokémon](/assets/portal/guides/release-an-nft-drop-with-no-code/dashboard.png)
...
![Embed tab](/assets/portal/guides/release-an-nft-drop-with-no-code/embed-tab.png)
...
![Embed configuration](/assets/portal/guides/release-an-nft-drop-with-no-code/embed-config.png)
...
- **Relayer Url**: Provide a relayer url to use for this embed. A relayer can be used to make the transaction gas-less for the end user. [Learn more](/guides/setup-gasless-transactions).
