...
- **Maximum mint supply in phase**: How many NFTs are going to be available for minting in this phase, in my case, 152 (A pokeball and 151 Gen 1 Pokémon) will all be avaiable for minting when this phase begins.
...
Click "**Batch Upload**" at the top of your Drop Module.
...
Click on the "**Embed**" tab on the drop module. This is the configuration that thirdweb offers:
