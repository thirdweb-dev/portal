...
draft: true
tags: [nft-drop, react, claim, frontend]
...
Let's create a components under `components/ClaimButton.tsx`. If you want to know more about the drop module you can find guides [here](/guides/nft-drop).
