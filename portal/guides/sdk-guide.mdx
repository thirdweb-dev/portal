...
If you want to know more about how a connection with a blockchain works, click [here](/learn/connect-to-blockchain).
...
export default function ConnectMetamaskButtonComponent() {
...
export default function MarketPlace() {
  ...
  // using the thirdweb hook
  // to access the Marketplace as an example
  const market =useMarket("0xf4e8C436d87Bd4cB1416E474948105FdF80BB6A0")
