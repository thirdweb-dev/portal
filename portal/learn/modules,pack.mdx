...
![](/assets/portal/docs/pack-diagram.png)
...
For the set of 100 packs with three kinds of items - 5, 15 and 80 of each across that set of packs - there's a `5/100` i.e. 5%, 15% and 80% chance, respectively, of receiving that item on opening a pack. You can find a more detailed version of this example, [here](/docs/protocol/overview).
...
![](/assets/portal/docs/pack-distribution.png)
...
![](/assets/portal/docs/pack-final-diagram.png)
