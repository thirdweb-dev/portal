...
4. Restricted transfer (check out this use case with Bundle Drop [here](/guides/make-your-nft-non-transferable))
...
![Module addresses](/assets/portal/learn/token-module/modules.png)
