...
draft: false
tags: [nft, module, sdk]
summary: "This guide explains our NFT Collection Module - An ERC7-21 contract that enables you to mint one-of-one NFTs"
date: "2022-01-26"
updated: ""
---
...
If you’re looking for a module that can mint multiple NFTs based on the same asset (ERC-1155 standard), check out our `Bundle Collection` module [here](/guides/bundle-collection).

Perhaps you’re looking to efficiently create and distribute 10k pfp style collections, then check out our `Bundle Drop` module [here](/guides/bundle-drop).
...
2. List an NFT for sale on a [Marketplace](/guides/marketplace) (you would also need the `Marketplace` module for this)
...
![Overview of modules and their addresses](/assets/portal/learn/nft-collection/module-address.png)
...
1. You can find code snippets for every method in our portal [here](/learn/code-examples/nft-collection).
2. To check out guides for this module click [here](/guides/nft-collection).
3. To setup your local dev environment, click [here](/guides/sdk-guide).

<MdxNavigation>
  <MdxNavigationItem href="/learn/modules" title="Modules" />
  <MdxNavigationItem href="/learn/modules/bundle-collection" title="Bundle Collection" next />
</MdxNavigation>
