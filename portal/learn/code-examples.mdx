...
The starting code for this examples can be found on this [GitHub repository](https://github.com/thirdweb-dev/examples/tree/main/typescript/typescript-sdk), so feel free to clone this instead of doing it yourself.
