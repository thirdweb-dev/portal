...
Setting up a contract is a matter of a few clicks! Click **[here](/learn/introduction)** to create and deploy your first contract.

![Overview of our contracts](/assets/portal/learn/index/modules.png)
...
```jsx
// Initialize market contract by passing in the contract address
const marketplaceContract = "<MARKETPLACE_CONTRACT_ADDRESS>";
const marketplace = sdk.getMarketplace(marketplaceContract);
...
const marketplaceContract = "0xC06adC34097afa2085324D4192fbE9206059f8e0";
const marketplace = sdk.getMarketplace(marketplaceContract);
...
- [TypeScript SDK](https://thirdweb-dev.github.io/typescript-sdk/sdk.html)
