...
3. `Voting Delay` is the time period after which members can vote on the proposal. This needs to be specified in numbers of blocks. Check your chain how many block are generated in an hour or day, so you know what number to fill in here. For example as of now, Ethereum generates a block every approximately 14 seconds.
