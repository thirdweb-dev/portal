...
draft: false
summary: "The NFT Drop contract gives you a distribution mechanism for your 1-of-1 NFTs."
date: "2022-02-13"
updated: "2022-03-14"
---
...
![Select 'Release a drop' on the dashboard](/assets/portal/contracts/nft-drop/select-release-a-drop-on-dashboard.png)
...
![Select type of drop - here we choose 'NFT Drop' for 1-of-1 NFTs](/assets/portal/contracts/nft-drop/select-type-of-drop-on-dashboard.png)
...
![Setting your claim phases on the dashboard](/assets/portal/contracts/nft-drop/nft-drop-add-allowlist-claim-phase.png)
...
![thirdweb dashboard view of contract addresses](/assets/portal/contracts/nft-drop/thirdweb-dashboard-with-contract-address.png)

![NFT Drop view of contract address](/assets/portal/contracts/nft-drop/nft-drop-contract-deployed-on-dashboard.png)
