...
draft: true
summary: "This guide explains our NFT Collection Contract - An ERC7-21 contract that enables you to mint one-of-one NFTs"
date: "2022-01-26"
updated: "2022-03-14"
---
...
You can find the contract address in the thirdweb dashboard, inside your project or inside the `NFT Collection` contract itself.

![Overview of contracts and their addresses](/assets/portal/contracts/nft-collection/contract-address.png)
