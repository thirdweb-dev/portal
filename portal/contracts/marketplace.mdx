...
![Select Marketplace from dashboard options](/assets/portal/contracts/marketplace/select-marketplace-from-dashboard.png)
...
You can use the `Marketplace` by using code or no-code. Head over to our dashboard to make use of the no-code solution. To use the code solution, you need to install our packages and instantiate our SDK first. Check out [this](/contracts/connect-to-blockchain) page on how to do that. You'll also need the address of your `Marketplace` contract. You can find that on the dashboard in your `Marketplace` contract.

![Contract address shown in Marketplace contract page](/assets/portal/contracts/marketplace/marketplace-contract-address.png)
...
![List an NFT on your marketplace](/assets/portal/contracts/marketplace/create-new-listing.png)
...
![NFT listed for sale by Listing Id on your Marketplace embed](/assets/portal/contracts/marketplace/marketplace-for-sale-embed.png)
