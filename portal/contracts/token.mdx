...
<SimpleGrid columns="2" gap="5">
  <MdxLinkCard
    title="Guides"
    subtitle="Guides about Token"
    contractType="token"
    type="guide"
  />
  <MdxLinkCard
    title="JavaScript/TypeScript docs"
    subtitle="Learn how to use the Token contract with our SDK"
    contractType="token"
    type="docs"
  />
</SimpleGrid>
...
![Select Token from dashboard options](/assets/portal/contracts/token/select-token-from-dashboard.png)
...
![Contract address shown in Token contract page](/assets/portal/contracts/token/token-contract-address.png)
...
<MdxNavigation>
  <MdxNavigationItem href="/contracts/edition-drop" title="Edition Drop" />
  <MdxNavigationItem href="/contracts/marketplace" title="Marketplace" next />
</MdxNavigation>
