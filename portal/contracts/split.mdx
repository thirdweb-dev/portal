...
<SimpleGrid columns="2" gap="5">
  <MdxLinkCard
    title="Guides"
    subtitle="Guides about Split"
    contractType="split"
    type="guide"
  />
  <MdxLinkCard
    title="JavaScript/TypeScript docs"
    subtitle="Learn how to use the Split contract with our SDK"
    contractType="split"
    type="docs"
  />
</SimpleGrid>
...
<MdxNavigation>
  <MdxNavigationItem href="/contracts/pack" title="Pack" />
  <MdxNavigationItem href="/contracts/vote" title="Vote" next />
</MdxNavigation>
