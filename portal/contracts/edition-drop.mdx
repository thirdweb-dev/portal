...
authorAvatar: "/assets/portal/authors/devin-rattray.jpg"
authorTwitter: "https://twitter.com/dvnsctt"
draft: false
summary: "The Edition Drop contract gives you a distribution mechanism for your 1-of-many NFTs."
date: "2022-03-14"
updated: ""
---
...
![Select 'Release a drop' on the dashboard](/assets/portal/contracts/edition-drop/select-release-a-drop-on-dashboard.png)

Click [here](/contracts) to learn more about contracts and how to create them.

## How it works

Make sure you choose the right contract. If you want your drop to include 1-of-many NFTs, choose the **`Edition Drop`** contract. If you want to mint 1-of-1 NFTs, choose the `NFT Drop` contract.
...
![Select type of drop - here we choose 'Edition Drop' for 1-of-many NFTs](/assets/portal/contracts/edition-drop/select-type-of-drop-on-dashboard.png)
...
![Setting your claim phases on the dashboard](/assets/portal/contracts/edition-drop/setting-edition-drop-claim-phases-on-dashboard.png)
...
![Embed settings](/assets/portal/contracts/edition-drop/edition-drop-minting-embed.png)
...
![thirdweb dashboard view of contract addresses](/assets/portal/contracts/edition-drop/dashboard-view-of-contract-addresses.png)
...
```jsx
const editionDrop = sdk.getEditionDrop("<NFT_DROP_ADDRESS>");
...
2. To check out guides for this contract click [here](portal/guides/edition-drop).
