...
<SimpleGrid columns="2" gap="5">
  <MdxLinkCard
    title="Guides"
    subtitle="Guides about Edition Drop"
    contractType="edition-drop"
    type="guide"
  />
  <MdxLinkCard
    title="JavaScript/TypeScript docs"
    subtitle="Learn how to use the Edition Drop contract with our SDK"
    contractType="edition-drop"
    type="docs"
  />
</SimpleGrid>
...
<MdxNavigation>
  <MdxNavigationItem href="/contracts/nft-drop" title="NFT Drop" />
