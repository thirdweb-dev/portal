...
3. After that you can make use of the methods in our sdk, this is how it looks:
...
<MdxNavigation>
  <MdxNavigationItem href="/learn-thirdweb" title="Getting started" />
  <MdxNavigationItem href="/contracts" title="Contracts" next />
</MdxNavigation>
