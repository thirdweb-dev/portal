...
export const FeatureIconMap: Record<ModuleType, StaticImageData> = {
  ...
  [ModuleType.COLLECTION]: require("public/assets/tw-icons/edition.png"),
  [ModuleType.PACK]: require("public/assets/tw-icons/pack.png"),
  [ModuleType.MARKET]: require("public/assets/tw-icons/marketplace.png"),
  [ModuleType.MARKETPLACE]: require("public/assets/tw-icons/marketplace.png"),
  ...
  [ModuleType.SPLITS]: require("public/assets/tw-icons/split.png"),
  [ModuleType.VOTE]: require("public/assets/tw-icons/vote.png"),
  [ModuleType.BUNDLE_SIGNATURE]: require("public/assets/tw-icons/edition.png"),
};
