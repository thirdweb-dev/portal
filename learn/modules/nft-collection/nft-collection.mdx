...
If you’re looking for a module that can mint multiple NFTs based on the same image or music file, check out our `Bundle Collection` module [here](/portal/guides/bundle-collection).
