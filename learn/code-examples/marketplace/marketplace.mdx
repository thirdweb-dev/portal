...
const buyoutAuction = async () => {
  ...
  await marketplace.buyoutAuctionListing(1).catch((error) => console.error(error));
};
```
...
const cancelAuction = async () => {
  ...
  await marketplace.cancelAuctionListing(0).catch((error) => console.error(error));
};
```
...
const cancelDirectListing = async () => {
  ...
  await marketplace.cancelDirectListing(1).catch((error) => console.error(error));
};
```
