...
![Select Module](/assets/portal/learn/wtf-are-projects-and-modules/select-module.png)
...
![Dashboard](/assets/portal/learn/wtf-are-projects-and-modules/dashboard.png)
...
![Deploy NFT module](/assets/portal/learn/wtf-are-projects-and-modules/deploy-nft-module.png)

### Permission Manager

The cool thing about **module** is that it also allows you to manage roles. You can easily assign and revoke roles suck as `Admin`, `Minter`, `Lister`, etc. These roles use the wallet address of an user. Again you can manage these roles inside a **module** via the dashboard or any of the SDKs we created.

![Permission Manager](/assets/portal/learn/wtf-are-projects-and-modules/permission-manager.png)
