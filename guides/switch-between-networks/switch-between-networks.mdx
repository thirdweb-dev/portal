...
![](./switch-to-polygon.jpg)

![](./network-list-phone.jpg)
...
![](./connect-wallet-dashboard.png)

![](./thirdweb-walletconnect.png)
...
![](./connect-wallet-eth-selected.png)

![](./create-project.png)

![](./setup-selecting-ethereum.png)
