...
- Some MATIC (You can get MATIC on the Mumbai Testnet of Polygon [here](/portal/guides/get-matic-on-polygon-mumbai-testnet-faucet/)
- Some basic experience with JavaScript and Node.js

Just in case you become unsure about your progress at some point, [take a look at the full source code here](https://github.com/nftlabs/examples/tree/main/typescript/create-a-pack-with-typescript-and-nextjs) and see whether this helps you to catch up again!
...
If you want to learn more about the thirdweb provider, [you can take a look at another tutorial here](https://thirdweb.com/portal/guides/add-connectwallet-to-your-website) that goes a little more in-depth about this component.
...
Unfortunately, implementing the whole logic to sign in users takes a little more time than we have here. You can, however, [follow our guide on letting your users sign in with their wallet](/portal/guides/sign-in-with-ethereum-using-thirdweb-connectwallet) to also implement this logic.
...
examples repository. [Take a look there](https://github.com/nftlabs/examples/tree/main/typescript/create-a-pack-with-typescript-and-nextjs) and see whether this helps you to catch up again!
